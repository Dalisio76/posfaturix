...
# -*- coding: utf-8 -*-
"""
Combina estrutura_completa.sql + dados_iniciais_usuario_permissoes.sql
"""
...
arquivo_dados = os.path.join(base_dir, "dados_iniciais_usuario_permissoes.sql")
arquivo_saida = os.path.join(base_dir, "estrutura_completa_com_dados_FINAL.sql")
...
# Ler dados iniciais
print("Lendo dados_iniciais_usuario_permissoes.sql...")
...
# Parte 2: Adicionar dados iniciais
linhas_final.append("\n")
linhas_final.append("-- =====================================================\n")
linhas_final.append("-- DADOS INICIAIS: USUÁRIO E PERMISSÕES\n")
linhas_final.append("-- Adicionado automaticamente por combinar_arquivos.py\n")
linhas_final.append("-- =====================================================\n")
linhas_final.append("\n")
...
print()
print("Agora você pode executar este arquivo no pgAdmin4:")
